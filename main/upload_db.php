...
if (isset($_POST["submit"])) {
    ...
    $allowedExt = ['sqlite', 'db'];

    if (!in_array($fileExt, $allowedExt)) {
        echo "❌ Error: Solo se permiten archivos .sqlite o .db";
    } else {
        if (move_uploaded_file($_FILES["db_file"]["tmp_name"], $target_file)) {
            ...
            echo "❌ Error al subir. Verifica los permisos.";
            error_log("Error al subir el archivo: " . print_r($_FILES, true));
        }
    }
}
?>
