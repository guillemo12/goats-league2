...
if (isset($_POST["submit"])) {
    ...
    if ($file_extension !== "sqlite") {
        ...
        if (move_uploaded_file($_FILES["db_file"]["tmp_name"], $target_file)) {
            ...
            echo "❌ Error al subir. Por favor contacte al administrador.";
            error_log("Error al subir DB. Archivo: " . print_r($_FILES, true) . ". Carpeta escribible: " . (is_writable($target_dir) ? 'SÍ' : 'NO'));
        }
    }
}
?>
