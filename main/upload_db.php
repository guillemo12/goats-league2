...
if (isset($_POST["submit"])) {
    if (move_uploaded_file($_FILES["db_file"]["tmp_name"], $target_file)) {
        ...
        echo "❌ Error al subir. Consulte los registros para obtener más detalles.";
        error_log("Detalles de error de carga: " . print_r($_FILES, true));
        error_log("¿La carpeta es escribible?: " . (is_writable($target_dir) ? 'SÍ' : 'NO'));
    }
}
?>
